...
void do_cmd_escape(void)
{
	...
	{
	case 0: do_cmd_note("You returned empty handed.", p_ptr->depth);
		break;
	case 1: do_cmd_note("You brought back a Silmaril from Morgoth's crown!", p_ptr->depth);
		break;
	case 2: do_cmd_note("You brought back two Silmarils from Morgoth's crown!", p_ptr->depth);
		break;
	case 3: do_cmd_note("You brought back all three Silmarils from Morgoth's crown!", p_ptr->depth);
		break;
	default: do_cmd_note("You brought back so many Silmarils that people should be suspicious!", p_ptr->depth);
		break;
	}
...
void close_game(void)
{
	...
	/* Still alive and in a normal game mode */
	else if (p_ptr->game_type == 0)
	{
		/* Save the game */
		do_cmd_save_game();
 ...
 */
static void get_tile(int row, int col, byte* a_def, signed char* c_def)
{
	byte a;
	signed char c;
 ...
 *
 */
static void get_default_tile(int row, int col, byte* a_def, signed char* c_def)
{
	byte a;
	signed char c;
...
extern void mini_screenshot(void)
{
	...
	signed char screen_char[100][200];
