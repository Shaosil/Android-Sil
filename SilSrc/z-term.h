...
struct term
{
	...
	errr (*text_hook)(int x, int y, int n, byte a, const signed char* s);

	errr (*pict_hook)(int x, int y, int n, const byte *ap, const signed char *cp, const byte *tap, const signed char *tcp);
};
